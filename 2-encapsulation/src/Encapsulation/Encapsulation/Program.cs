...
public class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Initial stock of {laptop.Name}: {laptop.Quantity}");
        Console.WriteLine($"Total value: ${laptop.GetTotalValue()}");

        laptop.AddStock(5);
        Console.WriteLine($"After adding 5: {laptop.Quantity}");

        laptop.SellProduct(3);
        Console.WriteLine($"After selling 3: {laptop.Quantity}");
        Console.WriteLine($"New total value: ${laptop.GetTotalValue()}");
    }
}
